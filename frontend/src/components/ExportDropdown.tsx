/** ExportDropdown -- Globaler "Alles exportieren"-Button mit PDF/Markdown-Auswahl. */
...
export function ExportDropdown({ getData, filename }: ExportDropdownProps) {
  ...
  return (
    <div ref={containerRef} className="relative inline-block">
      ...
      {open && (
        <div
          role="menu"
          className="absolute right-0 top-full mt-1 w-60 bg-white dark:bg-neutral-800 shadow-lg rounded-lg border border-neutral-200 dark:border-neutral-700 z-20 overflow-hidden"
        >
          <button
            role="menuitem"
