...
- **Global scope**: `E:/Claude Projekte/Tobias/paragraf v2/.claude/notes/{YYYY-MM-DD}-{slug}.md` — fallback when no `.planning/`, or when `--global` flag is present
...
2. Ensure the notes directory exists (`.planning/notes/` or `E:/Claude Projekte/Tobias/paragraf v2/.claude/notes/`)
...
2. Glob `E:/Claude Projekte/Tobias/paragraf v2/.claude/notes/*.md` (if directory exists) — global notes
...
Global (E:/Claude Projekte/Tobias/paragraf v2/.claude/notes/):
...
2. **No `.planning/`**: Falls back to global `E:/Claude Projekte/Tobias/paragraf v2/.claude/notes/` — works in any directory
