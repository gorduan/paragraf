...
```bash
PHASE_INFO=$(node "E:/Claude Projekte/Tobias/paragraf v2/.claude/get-shit-done/bin/gsd-tools.cjs" find-phase "${PHASE}")
```
...
```bash
PHASE_CHECK=$(node "E:/Claude Projekte/Tobias/paragraf v2/.claude/get-shit-done/bin/gsd-tools.cjs" roadmap get-phase "${PHASE}" --pick found)
...
```bash
PHASE_DIR=$(node "E:/Claude Projekte/Tobias/paragraf v2/.claude/get-shit-done/bin/gsd-tools.cjs" find-phase "${PHASE}" --raw)
```
