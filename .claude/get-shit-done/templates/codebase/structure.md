...
- Usage: Reference from command with `@E:/Claude Projekte/Tobias/paragraf v2/.claude/get-shit-done/workflows/{name}.md`
...
**get-shit-done/**
- Purpose: Resources installed to E:/Claude Projekte/Tobias/paragraf v2/.claude/
- Source: Copied by bin/install.js during installation
- Committed: Yes (source of truth)

**commands/**
- Purpose: Slash commands installed to E:/Claude Projekte/Tobias/paragraf v2/.claude/commands/
- Source: Copied by bin/install.js during installation
- Committed: Yes (source of truth)
