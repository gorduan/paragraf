...
Reference full template: `E:/Claude Projekte/Tobias/paragraf v2/.claude/get-shit-done/templates/roadmap.md`

## STATE.md Structure

Use template from `E:/Claude Projekte/Tobias/paragraf v2/.claude/get-shit-done/templates/state.md`.
