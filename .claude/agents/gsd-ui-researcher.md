...
Use template from `E:/Claude Projekte/Tobias/paragraf v2/.claude/get-shit-done/templates/UI-SPEC.md`.
...
Read template: `E:/Claude Projekte/Tobias/paragraf v2/.claude/get-shit-done/templates/UI-SPEC.md`
...
```bash
node "E:/Claude Projekte/Tobias/paragraf v2/.claude/get-shit-done/bin/gsd-tools.cjs" commit "docs($PHASE): UI design contract" --files "$PHASE_DIR/$PADDED_PHASE-UI-SPEC.md"
```
