...
- [x] **SRCH-02**: Qdrant Discovery API -- explorative Suche mit Positiv/Negativ-Beispielen
- [x] **SRCH-03**: Qdrant Grouping API -- Suchergebnisse nach Gesetz gruppiert zurueckgeben
...
- [x] **UI-02**: "Aehnliche Paragraphen"-Button auf ResultCard (Recommend API)
- [x] **UI-03**: Ergebnis-Gruppierung nach Gesetz/Rechtsgebiet in SearchPage
...
- [x] **UI-11**: Responsive Design-Verbesserungen und Accessibility-Audit (WCAG 2.1 AA)
