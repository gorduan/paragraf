...
- [x] **Phase 18: Documentation & Beta Release** - README-Ueberarbeitung, Installationsanleitung, API-Guide, MCP-Guide, Version 0.9-beta (completed 2026-04-01)
...
- [x] 15-02-PLAN.md — React setup wizard UI (5 steps), App.tsx first-run routing, deferred Docker startup
...
- [x] 16-02-PLAN.md — Electron IPC extensions (GPU switch, cache management, Docker GPU overlay support)
- [x] 16-03-PLAN.md — Frontend wizard steps (ModelDownload, GpuDetection) + SettingsPage extensions (GPU toggle, cache management)
...
| 18. Documentation & Beta Release | v2.0 | 0/3 | Complete    | 2026-04-01 |
